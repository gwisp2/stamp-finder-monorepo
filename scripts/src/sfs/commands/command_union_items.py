...
from sfs.core.items import parse_shops_metadata_from_json, parse_shop_items_from_json, \
    combine_list_of_shop_items_with_metadata, export_shops_to_json
...
class CommandUnionItems(Command):
    ...
    def run(self, args):
        ...
        shops = combine_list_of_shop_items_with_metadata(shop_items_list, shops_metadata)
